...
Usage:
    python scripts/run_phase1.py [--start-season 2024] [--end-season 2025]
"""
...
from src.ingest.player_ids import harmonize_projection_names
...
def main() -> int:
    ...
    results = run_phase1_all_seasons(hist_df, projections, config, seasons=seasons)
